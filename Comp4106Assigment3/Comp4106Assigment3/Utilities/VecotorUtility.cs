...
namespace Comp4106Assigment3.Utilities
{
    public static class VecotorUtility
    {
        ...
        public static int CountNumberOfTimesColumnEquals(
            List<double[]> vectors,
            int column,
            double value)
        {
        ...
        public static int CountNumberOfTimesColumnsEquals(
            List<double[]> vectors,
            int columnOne,
            int columnTwo,
            double valueOne,
            double valueTwo)
        {
            return vectors.Where(vector => 
            vector[columnOne] == valueOne 
            && vector[columnTwo] == valueTwo).Count();
        }
    }
}
